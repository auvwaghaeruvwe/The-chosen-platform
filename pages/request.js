...
export default async function handler(req, res) {
  ...
  try {
    ...
    await transporter.sendMail({
      from:    `"The Chosen Fan Platform" <${process.env.OUTLOOK_USER}>`,
      to:      process.env.MANAGEMENT_EMAIL || process.env.OUTLOOK_USER,
      replyTo: email,
    ...
    // Email 2 — Confirmation to fan
    await transporter.sendMail({
      from:    `"The Chosen Team" <${process.env.OUTLOOK_USER}>`,
      to:      email,
